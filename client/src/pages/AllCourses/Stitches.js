...
import StitchesForm from "../../components/AllForm/StitchesForm"
...
export default function Stitches() {
  ...
  const getData = async () => {
    const result = await axios.get("http://localhost:3001/stitches", {params: {userID: localStorage.getItem('userID')}});
  ...
  return (
    <Container size="sm">
      ...
      >
        <StitchesForm editItem={editItem}/>
      </Popup>
