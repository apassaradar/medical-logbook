...
import ObserveMajorForm from "../../components/AllForm/ObserveMajorForm"
...
export default function ObserveMajor() {
  ...
  const getData = async () => {
    const result = await axios.get("http://localhost:3001/observemajor", {params: {userID: localStorage.getItem('userID')}});
  ...
  return (
    <Container size="sm">
      ...
      <Popup title="แก้ไข้ข้อมูล รายชื่อผู้ป่วยที่ได้เข้าสังเกตการผ่าตัดใหญ่"
        ...
        <ObserveMajorForm editItem={editItem}/>
      </Popup>
