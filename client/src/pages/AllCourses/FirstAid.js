...
import FirstAidForm from "../../components/AllForm/FirstAidForm"
...
export default function FirstAid() {
  ...
  const getData = async () => {
    const result = await axios.get("http://localhost:3001/firstaid", {params: {userID: localStorage.getItem('userID')}});
  ...
  return (
    <Container size="sm">
      ...
      <Popup title="แก้ไข้ข้อมูล รายชื่อผู้ป่วยที่ได้เห็น First aid in major trauma"
        ...
        <FirstAidForm editItem={editItem}/>
      </Popup>
