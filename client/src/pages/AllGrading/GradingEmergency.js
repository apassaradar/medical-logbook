...
import GradingEmergencyForm from "../../components/AllGradingForm/GradingEmergencyForm"
...
export default function GradingEmergency() {
  ...
  const getData = async () => {
    const result = await axios.get("http://localhost:3001/gradingemergency");
  ...
  return (
    <Container size="sm">
      ...
      <Popup title="ตรวจสอบ การอยู่เวรห้องฉุกเฉิน"
        openPopup={openPopup} 
        setOpenPopup={setOpenPopup}>
        <GradingEmergencyForm editItem={editItem} />
      </Popup>
