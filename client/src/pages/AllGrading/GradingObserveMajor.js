...
import GradingObserveMajorForm from "../../components/AllGradingForm/GradingObserveMajorForm"
...
export default function GradingObserveMajor() {
  ...
  const getData = async () => {
    const result = await axios.get("http://localhost:3001/gradingobservemajor");
  ...
  return (
    <Container size="sm">
      ...
      <Popup title="ตรวจสอบ รายชื่อผู้ป่วยที่ได้เข้าสังเกตการผ่าตัดใหญ่"
        openPopup={openPopup} 
        setOpenPopup={setOpenPopup}>
        <GradingObserveMajorForm editItem={editItem} />
      </Popup>
