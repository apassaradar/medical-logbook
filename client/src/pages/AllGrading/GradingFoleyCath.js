...
import GradingFoleyCathForm from "../../components/AllGradingForm/GradingFoleyCathForm"
...
export default function GradingFoleyCath() {
  ...
  const getData = async () => {
    const result = await axios.get("http://localhost:3001/gradingfoleycath");
  ...
  return (
    <Container size="sm">
      ...
      <Popup title="ตรวจสอบ รายชื่อผู้ป่วยที่ได้ใส่ Foley Cath."
        ...
        <GradingFoleyCathForm editItem={editItem}/>
      </Popup>
