...
import GradingCVPForm from "../../components/AllGradingForm/GradingCVPForm"
...
export default function GradingCVP() {
  ...
  return (
    <Container size="sm">
      ...
      <Popup title="ตรวจสอบ รายชื่อผู้ป่วยที่ได้ทำการวัด CVP"
        openPopup={openPopup} 
